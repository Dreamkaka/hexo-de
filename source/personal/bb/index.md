...
// 页面说说
function pageTalk() {
    fetch('https://memos.itisn.cyou/api/memo?openId=eb364696-9c37-424e-a179-18ef9eee5fb6').then(res => res.json()).then(data => { // 注意修改域名和用户id
        let items = [],
            html = '',
